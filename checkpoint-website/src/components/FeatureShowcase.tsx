...
const features: FeatureBlock[] = [
  {
    ...
    body: 'The home screen shows one thing first: what\'s due next. A single card with the service name, status, and how many miles or days remain. Below it, your full maintenance timeline — color-coded by urgency. Green means good. Amber means soon. Red means now.',
    details: [
  ...
  },
  {
    ...
    details: [
      "20+ service type presets",
      "Photo and receipt attachments",
      "OCR text extraction from receipts (on-device)",
  ...
  },
  {
    ...
    body: "Checkpoint learns your driving rate and estimates your current mileage between updates. It uses a weighted moving average — recent trips count more. You can update manually, type it in, or just point your camera at the odometer.",
    details: [
      "Driving rate calculated from your history",
      "Predictive mileage estimation (EWMA, 30-day half-life)",
      "OCR odometer reading via camera",
